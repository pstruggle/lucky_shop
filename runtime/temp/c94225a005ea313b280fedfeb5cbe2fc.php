    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="block">
                ...
                <form action="<?php echo url('admin/System/edit'); ?>" method="post" class="form-horizontal form-bordered">
                    <div class="form-group">
                        <label class="col-md-3 control-label" for="send_mode">选择平台</label>
                        <div class="col-md-6">
                            <select name="send_mode" id="send_mode" class="form-control">
                                <option value="aliyun">阿里云</option>
                                <option value="alidayu">阿里大于</option>
                            </select>
                            <span class="help-block">选择发送短信的平台</span>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-3 control-label" for="sms_appkey">短信平台[appkey]</label>
                        <div class="col-md-6">
                            <input type="text" id="sms_appkey" name="sms_appkey" class="form-control" value="<?php echo $config['sms_appkey']; ?>" />
                            <span class="help-block">该短信平台[appkey]应从短信平台内获取</span>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-3 control-label" for="sms_secretKey">短信平台[secretKey]</label>
                        <div class="col-md-6">
                            <input type="text" id="sms_secretKey" name="sms_secretKey" class="form-control" value="<?php echo $config['sms_secretKey']; ?>"  />
                            <span class="help-block">该短信平台[secretKey]应从短信平台内获取</span>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-3 control-label">注册短信验证</label>
                        <div class="col-md-6">
                            <label class="switch switch-info">
                                <input type="checkbox" id="scene_reg" checked="" ><span></span>
                            </label>
                            <input type="hidden" class="is_true" name="scene_reg" value="<?php echo $config['scene_reg']; ?>"  >
                            <span class="help-block">是否开启注册短信验证</span>
                        </div>
                    </div>
...
<!-- Load and execute javascript code used only in this page -->
<script src="__APPUI__js/pages/system/sms.js"></script>
<script>
    var send_mode = "<?php echo isset($config['send_mode']) ? $config['send_mode'] : ''; ?>";
    $(function(){ Sms.init(); });
</script>
